...
//void DDMeasurementSurfaceStoreFiller::get_gear_parameters(const gear::GearMgr& gear_mgr) {
...
// void DDMeasurementSurfaceStoreFiller::getMeasurementSurfaces( std::vector<MeasurementSurface*>& surface_list ) const {
  
//   if( _paramVXD ) 
//     this->storeZPlanar( _paramVXD , UTIL::DDDetID::VXD, surface_list );
  
//   if( _paramSIT ) 
//     this->storeZPlanar( _paramSIT , UTIL::DDDetID::SIT, surface_list );
  
//   if(_paramSET  ) 
//     this->storeZPlanar( _paramSET , UTIL::DDDetID::SET, surface_list );
...
// void DDMeasurementSurfaceStoreFiller::storeZPlanar( const gear::ZPlanarParameters* param , int det_id, std::vector<MeasurementSurface*>& surface_list  ) const {
  
  
//   std::vector< double > angles;
//   std::vector< int > nsensors;
  
//   if( det_id == UTIL::DDDetID::VXD )  { 
    
//     angles = _VTXStripAngles;
//     nsensors = _VTXNSensors;
//   }
//   else if ( det_id == UTIL::DDDetID::SIT ){
//     angles = _SITStripAngles; 
//     nsensors = _SITNSensors;
//   }
  
//   else if ( det_id == UTIL::DDDetID::SET ){
...
//     streamlog_out(DEBUG1) << "DDMeasurementSurfaceStoreFiller::storeZPlanar :  nLadders = "  << nLadders  << std::endl ;
...
//         UTIL::BitField64  cellID( UTIL::DDCellID0::encoder_string );
//         cellID[ lcio::DDCellID0::subdet ] = det_id ;
//         cellID[ lcio::DDCellID0::side   ] = 0 ;
//         cellID[ lcio::DDCellID0::layer  ] = layerNumber ;
//         cellID[ lcio::DDCellID0::module ] = ladderNumber ;
//         cellID[ lcio::DDCellID0::sensor ] = sensorNumber ;
...
// 	streamlog_out(DEBUG1) << "DDMeasurementSurfaceStoreFiller::storeZPlanar :  ladder : "  << ladderNumber << " sensor : " << sensorNumber  
...
// void DDMeasurementSurfaceStoreFiller::storeFTD( const gear::FTDParameters* param, std::vector<MeasurementSurface*>& surface_list ) const {
  
//   const gear::FTDLayerLayout& ftdLayers = param->getFTDLayerLayout() ;
//   unsigned nLayers = ftdLayers.getNLayers();
  
//   UTIL::BitField64  cellID( UTIL::DDCellID0::encoder_string );
//   cellID[ lcio::DDCellID0::subdet ] = UTIL::DDDetID::FTD ;
  
//   for( unsigned layer = 0; layer < nLayers; layer++ ){
    
    
//     cellID[ lcio::DDCellID0::layer  ] = layer ;
...
//       cellID[ lcio::DDCellID0::module ] = petal ;
...
//         cellID[ lcio::DDCellID0::side   ] = -1 ;                    
//         cellID[ lcio::DDCellID0::sensor ] = sensor ;
//         int cellID0 = cellID.lowWord();
