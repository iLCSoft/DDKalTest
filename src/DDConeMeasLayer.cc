//*************************************************************************
//* ===================
//*  DDConeMeasLayer Class
//* ===================
//*
//* (Update Recored)
//*   2012/01/19  K.Fujii       Original version. (EXBPConeMeasLayer)
//*   2012/01/24 R.Glattauer    Adapted to DD common in KalDet
//*
//*************************************************************************
//
...
DDConeMeasLayer::DDConeMeasLayer(TMaterial &min,
                                     TMaterial &mout,
                                     Double_t   z1,
                                     Double_t   r1,
                                     Double_t   z2,
...
TVector3 DDConeMeasLayer::HitToXv(const TVTrackHit &vht) const
{
...
void DDConeMeasLayer::CalcDhDa(const TVTrackHit &vht,
                                 const TVector3   &xxv,
