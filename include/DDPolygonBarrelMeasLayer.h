#ifndef __DDSEGMENTEDDISCMEASLAYER_H__
#define __DDSEGMENTEDDISCMEASLAYER_H__

/** DDPolygonBarrelMeasLayer: User defined Polygonal Barrel KalTest measurement layer class to be used only for dead material. Segments are planes parallel to the z axis
 *
...
class DDPolygonBarrelMeasLayer : public DDVMeasLayer, public TVSurface {
public:
  // Ctors and Dtor
  

  
  DDPolygonBarrelMeasLayer(TMaterial &min,
                            TMaterial &mout,
                            double   Bz,
                            ...
                            bool     is_active,
                            const Char_t    *name = "DDPolygonBarrelMeasL");
  

  ~DDPolygonBarrelMeasLayer(){ delete _enclosing_cylinder;}
...
private:
  ...
  std::vector<DDParallelPlanarMeasLayer> _planes;
