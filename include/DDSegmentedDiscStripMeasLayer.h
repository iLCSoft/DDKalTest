#ifndef __DDSEGMENTEDDISCSTRIPMEASLAYER_H__
#define __DDSEGMENTEDDISCSTRIPMEASLAYER_H__

/** DDSegmentedDiscStripMeasLayer: User defined Segemented Disk Planar KalTest measurement layer class used with DDPLanarTrackHit. Segments are isosolese trapezoids whose axis of symmetry points to the origin 
...
class DDSegmentedDiscStripMeasLayer : public DDSegmentedDiscMeasLayer {

public:
  // Ctors and Dtor
  
  DDSegmentedDiscStripMeasLayer(TMaterial &min,
                                 TMaterial &mout,
                                 double   Bz,
  ...
  : DDSegmentedDiscMeasLayer(min,mout,Bz,SortingPolicy,nsegments,zpos,phi0,trap_rmin,trap_height,trap_innerBaseLength,trap_outerBaseLength,is_active,CellIDs,name), 
