...
/** DDRotatedTrapMeaslayer: User defined Rotated Trapezoid Planar KalTest measurement layer class used with DDPLanarTrackHit.
 *
 * @author S.Aplin DESY
 */
...
class DDRotatedTrapMeaslayer : public DDVMeasLayer, public TPlane {
...
public:
  ...
  DDRotatedTrapMeaslayer(TMaterial &min,
                          TMaterial &mout,
                          ...
                          Bool_t     is_active,
                          Int_t      CellID = -1,
                          const Char_t    *name = "DDRotatedTrapMeasL");
