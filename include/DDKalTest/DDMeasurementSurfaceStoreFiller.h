#ifndef DDMEASUREMENTSURFACESTOREFILLER_H
#define DDMEASUREMENTSURFACESTOREFILLER_H

#include <vector>
#include <string>


class DDMeasurementSurfaceStoreFiller { //: public MeasurementSurfaceStoreFiller{
  
  public:

   
  // DDMeasurementSurfaceStoreFiller(const gear::GearMgr& gear_mgr) :
  //   _nVTXLayers(0),
  //   _nSITLayers(0),
  //   _nFTDLayers(0),
  //   _nSETLayers(0) {
  ...
  ~DDMeasurementSurfaceStoreFiller() { /* no op */ }
  
  // void getMeasurementSurfaces( std::vector<MeasurementSurface*>& surface_list ) const;
  
  std::string getName() const { return "DDMeasurementSurfaceStoreFiller" ; } ;    
  ...
  //  * 
  //  * @param det_id: the detector id (as in DDConf)
  //  */
