...
/** DDSegmentedDiscMeasLayer: User defined Segemented Disk Planar KalTest measurement layer class used with DDPLanarTrackHit. Segments are isosolese trapezoids whose axis of symmetry points to the origin 
...
class DDSegmentedDiscMeasLayer : public DDVMeasLayer, public TPlane {
public:
  // Ctors and Dtor
  
  DDSegmentedDiscMeasLayer(TMaterial &min,
                            TMaterial &mout,
                            double   Bz,
